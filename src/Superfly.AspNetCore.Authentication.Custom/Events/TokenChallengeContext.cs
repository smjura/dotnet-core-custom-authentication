...
{
    public class TokenChallengeContext : PropertiesContext<CustomTokenOptions>
    {
        public TokenChallengeContext(
            HttpContext context,
        ...
        /// <see cref="CustomTokenOptions.IncludeErrorDetails"/> is set to <c>false</c>.
        /// </summary>
